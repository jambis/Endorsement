...
The interview will be conducted by either an instructor, or an engineer. I happened to get interviewed by an engineer, former Lambda School student. It is recommended that you use your projects from build week 3 and build week 4, but you can use as little or as many projects as you like as long as you can answer the questions.

## Questions

### Frontend

- Where have you implemented global state management, why did you implement it?
- What steps did you take to implement redux in your project?
- What is accessibility and why is it important?
- Can you demonstrate in your web app where you communicated with an external API. How did you do it?
- Can you show me mobile design in your app and tell me what steps you took to get your app to be mobile responsive.
- Show me how you implemented routes in your web app.
- Questions about forms and having validation on them.
- What's another syntax to handle promises (async/await)?
